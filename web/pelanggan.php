...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="barangtambah.php"><button class="btn btn-primary mb-3" type="button">Tambah Pelanggan</button> <i class="ace-icon fa fa-signal"></i></a>
            <br>
            ...
            <table align="table-responsive" class=" table table-striped table-bordered table-hover" id="dynamic-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="pelangganedit.php?id=<?php echo $data['KodePelanggan'];?>"><button class="btn btn-warning">Ubah</button></a>
                            <a href="pelangganhapus.php?id=<?php echo $data['KodePelanggan'];?>"><button class="btn btn-danger">Hapus</button></a>
                        </td>
