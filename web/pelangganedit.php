<?php 
    ...
    if (isset($_POST['btnsimpan'])=='btnsimpan') {
        $KodeBarang = trim($_POST['KodePelanggan']);
        $Nama = trim($_POST['Nama']);
        $Alamat = trim($_POST['Alamat']);
        $Telp = trim($_POST['Telp']);

        $query_sql = "UPDATE tb_barang SET Nama ='$Nama', Alamat ='$Alamat', Telp='$Telp' WHERE KodePelanggan ='$KodePelanggan'";
        ...
        <form method="post" name="form1">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <input type="text" disabled value="<?php echo $data['KodePelanggan'];?>" name="KodePelanggan" class="form-control">
                    <input type="hidden" value="<?php echo $data['KodePelanggan']; ?>" name="KodePelanggan" class="form-control">
                <div class="form-group">
